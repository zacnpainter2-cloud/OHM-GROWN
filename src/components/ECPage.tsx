...
export function ECPage() {
  ...
  const status = currentEC !== null ? getStatus(currentEC) : null;
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex items-baseline gap-2">
              <span className="text-3xl">{currentEC !== null ? currentEC.toFixed(0) : "--"}</span>
      ...
      {/* Statistics Card */}
      <StatisticsCard title="EC" data={ecValues} unit="μS/cm" color="teal" decimals={0} rangeLabel={rangeLabelMap[timeRange]} />
          ...
          <ResponsiveContainer width="100%" height={400}>
            <LineChart data={chartData}>
              ...
              <XAxis
                ...
                height={60}
              />
              <YAxis className="text-xs" domain={[0, (max: number) => Math.ceil(max * 1.05)]} />
              <Tooltip 
                contentStyle={{ 
              ...
              <Line 
                ...
                strokeWidth={2}
                name="EC (μS/cm)"
                dot={filteredReadings.length > 50 ? false : { fill: '#f59e0b', r: 3 }}
