        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Water Usage (L/m²/day)</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="transpiration-lower">Lower Threshold (L/m²/day)</Label>
                <Input
                  id="transpiration-lower"
                  type="number"
                  step="0.1"
                  value={localThresholds.transpiration.lower}
                  onChange={(e) => handleInputChange("transpiration", "lower", e.target.value)}
                  placeholder="e.g., 2.0"
                />
              </div>
              <div className="space-y-2">
                <Label htmlFor="transpiration-upper">Upper Threshold (L/m²/day)</Label>
                <Input
                  id="transpiration-upper"
                  type="number"
                  step="0.1"
                  value={localThresholds.transpiration.upper}
                  onChange={(e) => handleInputChange("transpiration", "upper", e.target.value)}
                  placeholder="e.g., 5.0"
                />
              </div>
              {validationErrors.transpiration && (
                <p className="text-sm text-destructive">{validationErrors.transpiration}</p>
              )}
            </CardContent>
          </Card>
        </div>
